...
<table width="100%" border="0"   class="table-condensed">
 ...
 <tr>
  ...
  <tr>
    ...
    <td>
        <input type="text" id="txtTaxAmount" name="txtTaxAmount" class="textstyleBottom" 
               value="<?php echo  $bodycontent['rawpurchaseMaster']['GST_Taxableamount']?>" readonly="true"/>	
    </td>
    <td>IGST</td>
    <td>
  ...
  <tr>
    ...
    <td>
        <input type="text" class="textstyleBottom" id="txtTotalIncldTaxAmt" name="txtTotalIncldTaxAmt" 
                           value="<?php echo($bodycontent['rawpurchaseMaster']['GST_Totalgstincluded']); ?>" readonly="true"/>	
    </td>
    <td></td>
    <td>
  ...
  <tr>
    <td>Round off.</td>
    <td><input type="text" id="txtRoundOff" name="txtRoundOff" class="textstyleBottom" 
               value="<?php echo  $bodycontent['rawpurchaseMaster']['round_off']?>" /></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>Invoice Value</td>
    <td><input type="text" id="txtInvoiceValue" name="txtInvoiceValue" class="textstyleBottom" 
               value="<?php echo  $bodycontent['rawpurchaseMaster']['invoice_value']?>" readonly="true"/></td>
    <td></td>
    <td></td>
  </tr>
