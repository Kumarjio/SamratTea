...
<script src="<?php echo base_url(); ?>application/assets/js/html5button.js"></script>
...
<!--
    <div class="navbar navbar-default" role="navigation">
      ...
      <img width="30" height="30" src="<?php echo base_url();?>application/assets/images/green-tea-cup.jpg"/>&nbsp;<?php echo " ".$companyname;?>&nbsp;(&nbsp;<?php echo $startyear; ?>&nbsp;-&nbsp;<?php echo $endyear; ?>&nbsp;)&nbsp;</span>
          </a>
