  ...
  /**
   ...
   public function GSTinsertData($rawMatPurchaseMaster,$searcharray){
    ...
    private function GSTinsertVoucherDetails($voucherMasterId,$dataArr){
       ...
       //service account 
       $roundOff = ($dataArr["txtRoundOff"]==NULL?0:$dataArr["txtRoundOff"]);
       ...
       for($j=0;$j<$numberofDetails;$j++){
           ...
           if($j==0){
            $voucherDtl["voucher_amount"]=$dataArr["txtTaxableAmt"][$j] + $roundOff; //round will be added on first account
           }  else {
