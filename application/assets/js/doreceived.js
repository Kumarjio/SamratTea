...
function updateRecvDo(transDoRecvId,Serial){
        ...
        $("#stockupdatebtn_"+Serial).css("display","none");
        $("#stockupdloader_"+Serial).css("display","block");
    ...
    $.ajax({
        ...
        success: function(data) {
            if(data==2){
             ...
             $("#stockupdatebtn_"+Serial).css("display","block");
             $("#stockupdloader_"+Serial).css("display","none");
        },
