...
function getValidation(transpoId,serialId){
 ...
 function updateTransDo(transpoId,Serial){
    ...
    $("#dototransporterdloader_"+Serial).css("display","block");
    $("#updatedototransporterbtn_"+Serial).css("display","none");
    ...
    $.ajax({
        ...
        $("#dototransporterdloader_"+Serial).css("display","none");
        $("#updatedototransporterbtn_"+Serial).css("display","block");
