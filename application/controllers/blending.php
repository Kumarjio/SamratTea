...
class blending extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->session->userdata('logged_in')) {
            ...
            $result = $this->blendingmodel->getBlendingList($companyId,$yearId);
    ...
    public function showInvoice(){
        ...
        $result['invoice']=$this->blendingmodel->getInvoice($garden,$company);
    ...
    public function showLotNumber(){
        ...
        $result['lot']=  $this->blendingmodel->getLotNumber($garden,$invoice,$company);
    ...
    public function showGrade(){
        ...
        $result['grade']=  $this->blendingmodel->getGradeNumber($garden,$invoice,$lot,$company);
    ...
    public function showTeaStock()
    {
       ...
       if ($this->session->userdata('logged_in')) {
           ...
           $divnumber = $this->input->post('divSerialNumber');
            ...
            $result['groupStock'] = $this->blendingmodel->getTeaStock($garden,$invoice,$lotNum,$grade,$company);
    ...
    public function purchaseExist()
    {
     ...
     public function checkDuplicateRefrenceNo()
    {
       $session = sessiondata_method();
       if ($this->session->userdata('logged_in')) {
           $refNo =  $this->input->post('refrenceNo');
           $cmpny = $session['company'];
           $yearid = $session['yearid'];
          
            $result = $this->blendingmodel->checkDuplicateRefno($refNo,$cmpny,$yearid);
    ...
    public function insertBlending(){
        ...
        $blendingMaster['avgblendCost'] =$searcharray['txtTotalAvgPrice'];
