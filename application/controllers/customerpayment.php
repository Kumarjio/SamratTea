	...
	public function deleteCutomerReceipt()
	{
		...
		if ($this->session->userdata('logged_in')) 
		{
              ...
              $user_activity_data =  array(
                                    ...
                                    "activity_module" => "Customer Receipt",
                                    "action" => "Delete",
                                    "narration" => "Deleted ID is ".$paymentId,
                                    "from_method" => "customerpayment/deleteCutomerReceipt",
                                    "user_id" => $session['user_id']
                                 );

			  $result = $this->customerpaymentmodel->DeleteCustomerReceipt($paymentId,$user_activity_data);
