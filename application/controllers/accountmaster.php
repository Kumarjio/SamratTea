...
class Accountmaster extends CI_Controller {
 ...
 public function getAccountList(){
     ...
     $result= $this->accountmastermodel->getAutoCompltAccount($term,$compny);
 	...
 	public function nameExist()
	{
	    ...
	    $customer=  $this->input->post('aName');
	    $res = $this->accountmastermodel->getAccountExist(trim($customer),$compny);
	    echo $res;
