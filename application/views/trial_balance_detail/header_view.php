...
<style>
 ...
 <h1><font color="#5cb85c" style="font-size:28px;">Trial Balance </font></h1>

 <div id="adddiv">

  <section id="loginBox" style="width:600px;border-radius:10px;">
      <form id="trialbalanceregister" name="trialbalanceregister" method="post" action="<?php echo base_url(); ?>trialbalancedetail/pdfTrialBalance"  target="_blank">
