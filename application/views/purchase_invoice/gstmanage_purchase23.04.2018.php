...
<table class="masterTable">
  ...
  <tr>
    <td>Invoice</td>
    <td><input type="text" name="taxinvoice" id="taxinvoice" value="<?php echo($bodycontent['purchaseMaster']['purchase_invoice_number']); ?>"/>
    
     <input type="hidden"  id="oldtaxinvoice" name="oldtaxinvoice" class="textStyle" value="<?php 
      if($header['mode']=="Edit"){
      echo $bodycontent['purchaseMaster']['purchase_invoice_number'];
      }else{echo "";}

      ?>"/> <p class="updatepurchase-invoice-validation-err" style="color: red;"></p>
  ...
  <tr>
    ...
    <td>Vendor</td>
    <td> 
       <input type="hidden"  id="oldvendor" name="oldvendor" class="textStyle" value="<?php 
        if($header['mode']=="Edit"){
      echo $bodycontent['purchaseMaster']['vendor_id'];}else{echo "";}
      ?>"/>
        ...
        <table class="gridtable" width="100%">
                ...
                <table class="gridtable" width="100%" id="sampleBag_<?php echo($dataContent['id']);?>">
                    ...
                    <?php foreach($dataContent['sampleBag'] as $sampleBagRows){ ?>
                        <tr id="row_<?php echo($dataContent['id']."_".$sampleBagRows['BagDetailId']);?>">
                            <td>
							...
							<!--
							<img src="<?php echo base_url();?>application/assets/images/delete-ab.png" title="Delete" alt="Delete" class="removeRow" id="<?php echo($dataContent['id']."_".$sampleBagRows['BagDetailId']);?>" style="cursor: pointer; cursor: hand;"/> -->
