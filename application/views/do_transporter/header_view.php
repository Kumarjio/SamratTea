      ...
      <form id="frmTransporter" name="frmTransporter" method="post" >
          ...
          <table>
              ...
              <tr>
                  ...
                  <td>&nbsp;&nbsp;&nbsp;</td>
                  <td>
                      <!--<input type="text" name="saleno" id="saleno" value="<?php echo $header['saleno']?>" class="textStyle"/>-->
    ...
    <tbody>        
                                 ...
                                 <?php if($bodycontent['doList']){
                                     ...
                                     foreach ($bodycontent['doList'] as $content){
                                       if( $content->do=="" || $content->doRealisationDate==""){echo "";}else{
                                           $sl=$sl+1;
                                           ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size:12px">
                                                 ...
                                                 <td>
                                                     ...
                                                     <input type="button" class="styled-button-10" value="update" id="updatedototransporterbtn_<?php echo($sl);?>"
                                                            onclick="updateTransDo(<?php echo(($content->dotransportaionid==''?"''":$content->dotransportaionid));?>,<?php echo($sl);?>);" />

                                                <img src="<?php echo base_url();?>application/assets/images/verify_logo.gif" alt="" id="dototransporterdloader_<?php echo($sl);?>" style="display: none;" /> 
