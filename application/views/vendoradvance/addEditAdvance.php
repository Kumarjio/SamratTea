...
<form id="addvendorAdvance" name="addvendorAdvance" method="post">
        ...
        <table width="80%" border="0" align="center" class="">
            ...
            <tr>
                <td></td>
                <td>
               <input type="hidden" id="payment_type_hidden" name="payment_type_hidden" value="<?php if($header['mode']=="Edit"){ 
                                    echo $bodycontent['vendoradvancement']['payment_type'];
                        }else{ echo "";}?>"> 

                 <input type="radio" id="payment_type_a" name="payment_type" value="PY" 
                  <?php if($header['mode']=="Edit"){ 

                                 if($bodycontent['vendoradvancement']['payment_type']=="PY")
                                 {
                                    echo "checked";
                                 }else{
                                    echo "";
                        ...
                        }else{ echo "checked";}?>> Payment &nbsp;&nbsp;  

                 <input type="radio" id="payment_type_b" name="payment_type" value="RC" 

                 <?php if($header['mode']=="Edit"){ 

                    if($bodycontent['vendoradvancement']['payment_type']=="RC")
                      {
                        echo "checked";
                      }else{echo "";} 
                   }?>> Receipt &nbsp;&nbsp;  
           ...
           <tr>
            ...
            <tr>
                <td >&nbsp;</td>
                <td colspan="2"><span class="adjusment-validation-err" style="color: red;"></span></td>
            </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
            </tr>
