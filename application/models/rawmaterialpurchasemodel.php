...
//check invoice_no existance data added on 05.04.2018 by shankha

    public function checkInvoiceExistanceData($invoice_no,$vendor,$year)
  {
        $where = array(
       "rawmaterial_purchase_master.`invoice_no`"=>$invoice_no,
       "rawmaterial_purchase_master.`vendor_id`"=>$vendor,
       "rawmaterial_purchase_master.`yearid`"=>$year
        );
