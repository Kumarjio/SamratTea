...
class stocksummerymodelall extends CI_Model {
    ...
    public function getStock($groupId,$frmPrice,$toPrice,$companyId,$toDate,$yearId) {
        ...
        if ($groupId == 0) {
            echo $call_procedure = "CALL sp_GetStockWithoutGroupAndCost_ALL(".$companyId.",'".$fiscalStartDate."','".$toDate."')";
			exit;
        }
        if($groupId!=0 && $frmPrice=="" && $toPrice==""){
          
            $call_procedure = "CALL sp_GetStockWithGroupWise_ALL(".$groupId.",".$companyId.",'".$fiscalStartDate."','".$toDate."')";
        }
        if($groupId==0 && $frmPrice!="" && $toPrice!=""){
         
            $call_procedure = "CALL sp_GetStockWithCostRangeWise_ALL(".$frmPrice.",".$toPrice.",".$companyId.",'".$fiscalStartDate."','".$toDate."')";
          
        }
        if($groupId!=0 && $frmPrice!="" && $toPrice!=""){
       
            
            $call_procedure = "CALL sp_GetStockWithGroupAndCost_ALL(".$groupId.",".$frmPrice.",".$toPrice.",".$companyId.",'".$fiscalStartDate."','".$toDate."')";
        }
